...
void AMyCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    PlayerInputComponent->BindAxis("MoveRightOrLeft", this, &AMyCharacter::MoveRightOrLeft);
    PlayerInputComponent->BindAxis("MoveForwardOrBack", this, &AMyCharacter::MoveForwardOrBack);
}
