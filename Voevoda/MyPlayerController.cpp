...
void AMyPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("SpaceButton", IE_Released, this, &AMyPlayerController::ScoutReleased2);
}
...
void  AMyPlayerController::ScoutReleased2() {

	FVector2D MousePosition = HUDPtr->GetMousePosition2D();
	FVector MousePositionFVector(MousePosition.X, MousePosition.Y, 1.f);
	Location MouseLocation(MousePositionFVector);
